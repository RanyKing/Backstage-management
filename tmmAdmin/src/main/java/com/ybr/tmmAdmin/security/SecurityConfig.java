...
import com.ybr.tmmAdmin.Service.AdminDetailService;
import com.ybr.tmmAdmin.security.handler.LoginErrorHandle;
import com.ybr.tmmAdmin.security.handler.LoginSuccessHandle;
import com.ybr.tmmAdmin.security.handler.LogoutSuccessHandle;
import com.ybr.tmmAdmin.security.handler.PermissionErrorHandle;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public void configure(WebSecurity web) throws Exception {
        ...
        web.ignoring().antMatchers("/admin/login","/common/**","/img/**","/css/**","/js/**","/favicon.ico","/assets/**")
